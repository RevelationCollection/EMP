...
-- 4、增加管理员信息
-- salt : jbpjava,Base64 : “bWxkbmphdmE=”，格式：密码password({salt})
-- admin / hello
INSERT INTO member(mid,password,name,sflag) VALUES ('admin','1F125746B45CA35BB79A2D88094D6020','管理员',1) ;
-- mermard / hello
INSERT INTO member(mid,password,name,sflag) VALUES ('mermaid','1F125746B45CA35BB79A2D88094D6020','老李',0) ;
-- jbp / java
INSERT INTO member(mid,password,name,sflag) VALUES ('jbp','38E01DF58006771BED2A54225134C41E','隔壁老王',0) ;
...
INSERT INTO member_role(mid,rid) VALUES ('mermaid',2) ;
INSERT INTO member_role(mid,rid) VALUES ('jbp',3) ;
INSERT INTO member_role(mid,rid) VALUES ('jbp',3) ;
-- 6、部门表数据
